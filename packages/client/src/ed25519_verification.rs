...
pub struct Ed25519VerificationClient {
    client_configs: ClientContractConfigs,
}

impl WarpdriveClient for Ed25519VerificationClient {
...
impl Ed25519VerificationClient {
    ...
    pub async fn signer_weight(&self, signer_pubkey: [u8; 32]) -> Result<u64, SorobanHelperError> {
        let res = query(
            &self.client_configs,
            "signer_weight",
