...
pub struct StellarHandlerClient {
    client_configs: ClientContractConfigs,
}

impl WarpdriveClient for StellarHandlerClient {
...
impl StellarHandlerClient {
    ...
    pub async fn verify_xlm(
        ...
        execute(&mut self.client_configs, "verify_xlm", args).await
    }
